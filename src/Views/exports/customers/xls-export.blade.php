<table>
    ...
    @foreach($records as $i => $record)
        ...
        @include('decalex-b2b-commons::exports.~pieces.td', ['caption' => $record['city']['name']])
        @include('decalex-b2b-commons::exports.~pieces.td', ['caption' => $record['city']['region']['name']])
        @include('decalex-b2b-commons::exports.~pieces.td', ['caption' => $record['city']['region']['country']['name']])
